...
![Image of crosscord in action](https://i.wotaku.wiki/f/image.png)

0. YOU ARE ON YOUR OWN. YOU WILL NEED THE PURCHASED GAME FILES TO USE THIS.
1. You will need: ffmpeg (unused but will be used in the future), bun, cloudflared. You will also need the game files in the `CrossCode/` directory.
2. Clone this repo with submodules, and run `bun run compile` to compile the game to make it load faster (it will be compiled to `compiled/`)
